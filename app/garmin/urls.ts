...
export const dailySpO2 = (date: Date) =>
  `${WELLNESS_SERVICE}/wellness/daily/spo2/${date.toISOString().split('T')[0]}`;
...
export const listGear = (userProfilePk: number, availableGearDate?: Date) =>
  `${GEAR_SERVICE}/gear/filterGear?userProfilePk=${userProfilePk}${availableGearDate
